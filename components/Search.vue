<template>
  <div
    ...
    :class="
      isSearching
        ? 'inset-0 fixed z-10 opacity-100  bg-slate-900 overflow-auto'
        : ' bg-slate-900 p-4 '
    "
  >
    ...
    >
      <input
        ...
        :class="
          isSearching
            ? 'top-1 max-w-5xl mx-auto inset-x-0 text-white fixed z-10 opacity-90  bg-slate-900 '
            : ''
        "
      ...
      <button
        ...
        @click="
          ...
          searchResults = [];
        "
        class="text-white fixed z-10  bg-slate-900 top-2 right-2"
      >
        <!-- icon for cancel -->
        <svg
