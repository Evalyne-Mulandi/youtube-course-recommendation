  ...
  <div>
   <!--  <nav class="bg-black py-4 shadow fixed inset-x-0 top-0 mb-4">
    ...
    <main class=" relative z-10"> 
      <div class="custom-shape-divider-top-1665683459">
  <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
      <path d="M985.66,92.83C906.67,72,823.78,31,743.84,14.19c-82.26-17.34-168.06-16.33-250.45.39-57.84,11.73-114,31.07-172,41.86A600.21,600.21,0,0,1,0,27.35V120H1200V95.8C1132.19,118.92,1055.71,111.31,985.66,92.83Z"  class="shape-fill" fill=""></path>
  </svg>
</div>
...
<!-- <div class="container px-6 pt-6">
  ...
  <div>
    <section class="  bottom-8 m-14 pt-24">
      <div class="max-w-7xl mx-auto py-6  px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-4 gap-8 md:grid-cols-8">
          <div class="col-span-2 md:col-span-1">
            <h3 class="md:text-sm font-extrabold   text-orange-600 sm:text-sm text-sm">
              About Us
            </h3>
          ...
          <div class="col-span-2 md:col-span-1">
            <NuxtLink
              to=""
              class="md:text-sm font-extrabold text-orange-600 sm:text-sm text-sm"
              >Pricing</NuxtLink
            >
            <ul class="low mt-4 space-y-4 font-light">
              <li>
          ...
          <div class="col-span-4 md:col-span-2 flex  h-48 w-48 ml-14 justify-end items-center">
            <img src="https://media.istockphoto.com/id/1248415310/photo/3d-illustration-of-startup-concept-and-business-teamwork-two-happy-men-with-laptops-sitting.webp?b=1&s=170667a&w=0&k=20&c=rLRkXsBhthdYSSYqCs23Pb8ZQHqt9db6dEOuxRCKOBM=" />
          </div>
        </div>
      </div>
    </section>
...
<style>
.custom-shape-divider-top-1665683459 {
  position: absolute;
  top: 0;
  left: 0;
  width: 100%;
...
.custom-shape-divider-top-1665683459 svg {
  position: relative;
  display: block;
