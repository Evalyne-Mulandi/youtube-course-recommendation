<template>
  ...
  <main class=" text-center justify-center items-center  bg-gradient-to-r from-slate-700 via-slate-900 to-slate-900  h-full">
    <div class=" pt-20  text-4xl     text-orange-600 font-extrabold">Learn the skills & Lead the future!!
         
 <div class=" p-24">
   <h1></h1>
     <button class="  px-7 py-3 bg-orange-600 rounded-full  text-xl text-black"><NuxtLink to="Login">Hello learner 👋</NuxtLink></button>
 </div> 
 </div>
    <svg  data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none" ><path  d="M985.66,92.83C906.67,72,823.78,31,743.84,14.19c-82.26-17.34-168.06-16.33-250.45.39-57.84,11.73-114,31.07-172,41.86A600.21,600.21,0,0,1,0,27.35V120H1200V95.8C1132.19,118.92,1055.71,111.31,985.66,92.83Z" class="shape-fill" fill="white" fill-opacity="1"></path></svg>  
  </main>
  <main>
