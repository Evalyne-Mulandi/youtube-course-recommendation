<template>
   <nav class="bg-black py-5 shadow fixed inset-x-0 top-0 mb-4">
    ...
    <section class="min-h-screen  m flex justify-center items-center ">
 <div class="w-full lg:w-6/12 px-4 mx-auto">
   <div class=" flex flex-col min-w-0 break-words border  border-gray-700  w-full mb-6 shadow-xl p-4 rounded-lg mt-16">
     <div class="px-6">
       ...
       <div class="text-center mt-8">
         ...
         <div class="text-sm leading-normal mt-0 mb-2  font-bold uppercase">
           <i class="fas fa-map-marker-alt mr-2 text-lg-400"></i>
           Nakuru , Kenya
         </div>
         <div class="mb-2  py-2 border-t border-blueGray-200 text-center    mt-10">
